...
export class MailService {
  ...
  async sendContactMail(
    ...
    const msg = {
      to: recieverAddr,
      from: '"Your Platform Name" <noreply@your-platform.example.com>',
      replyTo: senderAddr,
      subject: 'Kontaktaufnahme über Your Platform Name',
  ...
  async sendRegistrationMail(
    ...
    <br>
    Beste Grüße<br>
    Ihre Team von <b>Your Platform Name</b>
    `;
    const msg = {
      to: recieverEmail,
      from: '"Your Platform Name" <contact@your-platform.example.com>',
      subject: 'Registrierung abschließen bei Your Platform Name',
